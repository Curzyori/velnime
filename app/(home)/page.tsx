      ...
      <div className="mx-auto w-full max-w-6xl flex-1 px-4 sm:px-6">
        ...
        <section className="flex flex-col items-center py-20 text-center sm:py-28">
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row">
            ...
            <span
              className="inline-flex min-h-12 items-center gap-2 rounded-xl border border-white/10 bg-surface px-8 py-3.5 font-display text-sm font-bold text-inkDim cursor-not-allowed"
              title="Aplikasi sedang dalam tahap persiapan akhir rilis"
            >
